...
(function (StateJS) {
    ...
    var Region = (function (_super) {
        ...
        Region.prototype.remove = function () {
            this.vertices.forEach(function (vertex) { vertex.remove(); });
            this.state.regions.splice(this.state.regions.indexOf(this), 1);
            StateJS.console.log("remove " + this);
            this.state.getRoot().clean = false;
        };
        /**
...
(function (StateJS) {
    ...
    var Vertex = (function (_super) {
        ...
        Vertex.prototype.remove = function () {
            this.outgoing.forEach(function (transition) { transition.remove(); });
            this.incoming.forEach(function (transition) { transition.remove(); });
...
(function (StateJS) {
    ...
    var State = (function (_super) {
        ...
        State.prototype.remove = function () {
            this.regions.forEach(function (region) { region.remove(); });
...
(function (StateJS) {
    ...
    function evaluateState(state, instance, message) {
        ...
        if (result) {
            ...
            for (var t in transitions) // DISTI Changed to allow multiple transitions
            {
                result |= traverse(transitions[t], instance, message);
            }
/*            
    ...
    var InitialiseTransitions = (function (_super) {
        ...
        InitialiseTransitions.prototype.visitTransition = function (transition, behavior) {
            ...
            transition.onTraverse = new StateJS.Behavior();
        ...
        InitialiseTransitions.prototype.visitLocalTransition = function (transition, behavior) {
            ...
            transition.onTraverse.push(function (message, instance) {
                ...
                while (StateJS.isActive(targetAncestors[i], instance)&& i<targetAncestors.length-1) { // DiSTI added i check for when all are active
                    ++i;
                }
